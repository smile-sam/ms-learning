package com.ms.learning.designpatterns.facade.ch2;
...
class Specialty1 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty1() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty11.jpg");
    }
}
class Specialty2 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty2() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty12.jpg");
    }
}
class Specialty3 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty3() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty13.jpg");
    }
}
class Specialty4 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty4() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty14.jpg");
    }
}
class Specialty5 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty5() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty21.jpg");
    }
}
class Specialty6 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty6() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty22.jpg");
    }
}
class Specialty7 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty7() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty23.jpg");
    }
}
class Specialty8 extends ImageIcon {
    private static final long serialVersionUID = 1L;
    Specialty8() {
        super("src\\main\\resources\\static\\images\\wy\\Specialty24.jpg");
    }
}
